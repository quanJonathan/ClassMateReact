...
export default function AddPeopleDialog({
  ...
  const handleSendJoiningEmail = async (email) => {
    ...
    const body = {
      ...
      url:
        role === "teacher"
          ? `https://classmatefe-final.onrender.com/c/t/join/${course?._id}`
          : `https://classmatefe-final.onrender.com/c/join/${course?._id}`,
    };
    ...
    await axios
      ...
      .catch(function (error) {
        if (error.response) {
          ...
          toast.error(
            "Send Invitation Link Failed due to :" + error.response.data
          );
    ...
    result.email !== "admin2@gmail.com" && result.email !== "classmate.admin@gmail.com" && result.email !== user.email && (
        ...
        {result.email}
              ...
              <List sx={{ overflowY: "scroll", height: "100px" }}>
                {results?.map(
                  (item) =>
                    item.email !== "admin2@gmail.com" &&
                    item.email !== "classmate.admin@gmail.com" &&
                    item.email !== user.email && (
                      ...
                      >
                        ...
                        <Button
                          onClick={() => handleSendJoiningEmail(item.email)}
                          variant="contained"
                          color="primary"
                          elevation={0}
                          sx={{
